  ...
  return (
    <section id="contact" className="py-24 bg-gradient-to-br from-cyan-600 via-blue-600 to-teal-600 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="backdrop-blur-lg bg-white/95 border border-white rounded-3xl shadow-2xl overflow-hidden">
          <div className="p-10 lg:p-16 text-center">
            ...
            <div className="backdrop-blur-sm bg-gradient-to-br from-cyan-50 to-blue-50 border border-cyan-100 rounded-2xl p-10 max-w-2xl mx-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <input
                  ...
                  className="w-full px-6 py-4 rounded-xl border border-gray-200 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 outline-none transition-all text-lg bg-white"
                />
                <input
                  type="tel"
